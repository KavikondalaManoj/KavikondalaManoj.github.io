...
const translations = {
  en: {
    ...
    hero_role:"Senior Technical Lead", hero_role_sub:"Automotive OTA Validation Specialist",
  ...
  ja: {
    ...
    hero_role:"シニアテクニカルリード", hero_role_sub:"自動車OTA検証スペシャリスト",
  ...
  de: {
    ...
    hero_role:"Senior Technical Lead", hero_role_sub:"Spezialist für automobile OTA-Validierung",
